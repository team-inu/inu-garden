        ...
        <TableBody key={i}>
          <TableRow className="">
                ...
                <TableBody>
                  {courseOutcome.assessments &&
                    courseOutcome.assessments.map((assessment, i) => (
                      <TableRow key={i}>
                        ...
                        <TableCell className="truncate">{assessment.assessmentTask}</TableCell>
                  ...
                  <TableRow>
                    <TableHead className="truncate  bg-primary-foreground/20">
                      Students passing {courseOutcome.expectedPassingAssignmentPercentage}% of
                      {" this CLO's assessments"}
                    </TableHead>
                    <TableCell colSpan={2}>{courseOutcome.passingCloPercentage}%</TableCell>
                  </TableRow>
                </TableBody>
            ...
            <TableRow>
              ...
              <TableCell colSpan={2}>{tabeeOutcome.minimumPercentage}%</TableCell>
            </TableRow>
          </TableRow>
        </TableBody>
      ))}
