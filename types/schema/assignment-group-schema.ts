...
export const UpdateAssignmentGroupFormSchema = CreateAssignmentGroupFormSchema.omit({
  courseId: true,
}).extend({
  id: z.string(),
});

export type CreateAssignmentGroupForm = z.infer<typeof CreateAssignmentGroupFormSchema>;
export type UpdateAssignmentGroupForm = z.infer<typeof UpdateAssignmentGroupFormSchema>;
