    ...
    <>
      <div className="container relative hidden h-full flex-col items-center justify-center md:grid lg:max-w-none lg:grid-cols-2 lg:px-0">
        ...
        <div className="relative hidden h-full flex-col bg-muted p-10 text-white dark:border-r lg:flex">
          <Image className="absolute inset-0 bg-zinc-900" src="/images/landing.webp" layout="fill" alt={''} />
          ...
          <div className="relative z-20 mt-auto rounded-lg bg-secondary/80 p-5 hover:animate-pulse">
            <blockquote className="space-y-2">
              <p className="text-secondary-foreground">
                &ldquo;Inu is the best platform for managing your courses and assessments. It has everything you need to
                manage your courses.&rdquo;
              </p>
        ...
        <div className="lg:p-8">
          <div className="mx-auto flex w-full flex-col justify-center space-y-6 sm:w-[350px]">
            <div className="flex flex-col space-y-2 text-center">
              <div className="text-2xl font-semibold tracking-tight">Sign in an account</div>
